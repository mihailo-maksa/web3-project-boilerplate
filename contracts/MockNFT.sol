...
contract MockNFT is ERC721PresetMinterPauserAutoId {
  ...
  modifier maxNFTsChecker() {
    require(nftCounter.current() < MAX_NFTS, "MockNFT::maxNFTsChecker: all NFTs have been minted");
    _;
  }

  function mint(address _to) public virtual override maxNFTsChecker {
    ERC721._mint(_to, nftCounter.current());
